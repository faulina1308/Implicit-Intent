package com.faulinaindri202102297.myapplication;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void tampilKalkulator(View view) {
        ArrayList<HashMap<String, Object>> itema = new ArrayList<HashMap<String, Object>>();
        ...
        int item_size = itema.size();

        if (item_size >= 1) {
            String packageName = (String) itema.get(0).get("packageName");
